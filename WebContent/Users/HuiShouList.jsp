	...
	function show(e) {
		...
		if (top.topManager) {
			top.topManager.openPage({
				id : 'bmshow',
				href : "../../test2/HuiShouXiangQing?id=" + id,//iframe的url 
				title : '名片信息详情'
			});
		}
...
<body>
	<div id="main-container">
		...
		<div id="page-content">
			<div>
				<a onclick="huanYuanList()" class="btn btn-default">批量还原</a> <a
							...
							if (dd != null && dd.length > 0) {
								for ( var i in dd[0]) {
									...
									str += "<td>" + dd[0][i].gongZuoDanWei
											+ "</td>";
									str += "<td><span><a href='#' onclick='show(this)' > 详情</a></span>"
											+ "<span><a  class='huanyuanone' href='javascript:void(0)' style='cursor:point;'> 还原</a></span>"
